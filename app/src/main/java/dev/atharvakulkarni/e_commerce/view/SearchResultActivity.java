...
//        getWindow().setStatusBarColor(getResources().getColor(R.color.white,getTheme()));
    ...
    private void getProductsInCart()
    {
        ...
        search_result_adapter = new search_result_adapter(recyclerView, SearchResultActivity.this,new ArrayList<Integer>(),new ArrayList<String>(),new ArrayList<String>());
